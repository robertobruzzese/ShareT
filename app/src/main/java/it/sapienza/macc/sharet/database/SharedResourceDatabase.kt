...
abstract class SharedResourceDatabase: RoomDatabase() {
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: SharedResourceDatabase? = null
         ...
         */
        fun getInstance(context: Context): SharedResourceDatabase {
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        SharedResourceDatabase::class.java,
                        "shared_resources_database"
                    )
